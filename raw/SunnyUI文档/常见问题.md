...
-  **打开源码，显示依赖项都是感叹号**    
![输入图片说明](https://images.gitee.com/uploads/images/2021/0419/141000_65739de3_416720.png "屏幕截图.png")
  有可能是因为网络原因，连不上Nuget服务器，通过设置Nuget源为国内源即可。
  Nuget包管理器，设置程序包源：https://nuget.cdn.azure.cn/v3/index.json
![输入图片说明](https://images.gitee.com/uploads/images/2021/0416/234016_f87a8a0d_416720.png "屏幕截图.png")

-  **界面的一些小图标的数字代号，是什么意思啊？**
  ![输入图片说明](https://foruda.gitee.com/images/1695453668492154571/ba236da6_416720.png "屏幕截图")
  ![输入图片说明](https://images.gitee.com/uploads/images/2020/1027/092717_c9fb3e99_416720.png "2.png")
  对，就是图上框框里的图标和魔法数字，其实用的是WEB开发常见的字体图标，详见介绍：
  **字体图标** https://gitee.com/yhuse/SunnyUI/wikis/pages?sort_id=3739927&doc_id=1022550<br/><br/>

-  **为什么有些控件，我改了颜色，编辑时的界面显示了，然后一编译运行，颜色就变了？** 
  因为SunnyUI是带主题风格的，有统一的主题风格控件UIStyleManager来控制主题颜色。
  **主题** https://gitee.com/yhuse/SunnyUI/wikis/pages?sort_id=3739705&doc_id=1022550
  所以你自己改的颜色在运行时被主题颜色覆盖了。
  那有同学要问了，我就是要自己设置颜色，有没有方法呢？
  有的，SunnyUI也帮你考虑了。
  ![输入图片说明](https://images.gitee.com/uploads/images/2020/1027/094236_d9bc00e5_416720.png "3.png")
  就是更改颜色后，把控件的Style设置为Custom，StyleCustomMode设置为True
  StyleCustomMode就是接受用户自定义颜色的意思。<br/>

-  **控件属性那么多，SunnyUI到底怎么用呢？** 
  具体控件怎么用，主要还是看控件的属性，除了控件的原生属性外
  SunnyUI已经将添加的属性进行了分类，分类的标题就是SunnyUI
  ![输入图片说明](https://images.gitee.com/uploads/images/2020/1027/095848_3475ce27_416720.png "4.png")
  点击控件分类，选择SunnyUI类目下的属性，在页脚会有属性的说明。<br/>
...
-  **为什么继承的窗体，上面有小锁，能解开吗，还有就是继承的窗体，有些控件属性都设置不了，怎么办？** 
  ...
  举例：
  ![输入图片说明](https://foruda.gitee.com/images/1695453745398003227/011a9a81_416720.png "屏幕截图")
  继承的登录窗体的登录按钮有锁，但其点击事件已封装到父类的事件
  ![输入图片说明](https://images.gitee.com/uploads/images/2021/0304/105850_f7800c4b_416720.png "2.png")
<br/>

-  **为什么运行时的界面显示比设计期的大？** 
  设计期：
  ![输入图片说明](https://images.gitee.com/uploads/images/2021/0315/150904_4a613bb0_416720.png "11.png")
  运行期：
  ![输入图片说明](https://images.gitee.com/uploads/images/2021/0315/150921_ba2da459_416720.jpeg "12.jpg")
  引起界面放大的原因主要又两个，一是因为界面跟随字体放大，二是界面跟随屏幕的DPI缩放引起的。
  1. 因为显示的高分屏，然后操作系统的设置了字体缩放引起的。窗体默认的AutoScaleMode = Font，控件会因为高分屏自动缩放。
  解决方法：设置窗体、用户控件的AutoScaleMode = None <br/>
...
- **把控件从工具箱往界面上拖到时候的解决方法**  
  如图所示  
  ![输入图片说明](https://images.gitee.com/uploads/images/2021/0524/113921_3937490b_416720.png "屏幕截图.png")  
...
![输入图片说明](https://images.gitee.com/uploads/images/2021/0827/220602_755c9feb_416720.png "屏幕截图.png")  
...
UINavBar报错    
![输入图片说明](https://images.gitee.com/uploads/images/2022/0102/103655_1759d1cd_416720.png "屏幕截图.png")    
Symbol没有右侧的点击按钮    
...
- 未能加载程序集    
![输入图片说明](https://images.gitee.com/uploads/images/2022/0121/141104_f53790f6_416720.png "屏幕截图.png")    
...
![输入图片说明](https://foruda.gitee.com/images/1726733540808773992/1ff6a8f7_416720.png "屏幕截图")
确认编译环境符合项目说明
确认已经引用了SunnyUI控件，nuget引用没有黄色感叹号
清理项目，重新编译，关掉VS，再重新打开VS。一般能解决此问题。

- 无法处理 *.resx，因为它位于 Internet 或受限区域中，或者文件上具有 Web 标记。要想处理这些文件，请删除 Web 标记。
![输入图片说明](https://foruda.gitee.com/images/1730344050171543091/99d27140_416720.png "屏幕截图")
解决方法：
找到这个文件，打开属性，解除锁定
![输入图片说明](https://foruda.gitee.com/images/1730344105321088751/5344d733_416720.png "屏幕截图")
