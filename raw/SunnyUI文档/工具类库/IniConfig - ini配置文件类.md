看过 [IniFile - Ini文件读写类 ](https://gitee.com/yhuse/SunnyUI/wikis/pages?sort_id=4143192&doc_id=1022550)，应该基本了解Ini文件的定义和读写了。  
- 写文件  
~~~
...
3、支持的属性类型见[IniFile - Ini文件读写类 ](https://gitee.com/yhuse/SunnyUI/wikis/pages?sort_id=4143192&doc_id=1022550)